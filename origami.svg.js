/*!!
 *  Origamijs to SVG (origamijs.svg)
 */
...
;(function() {
  ...
  ctx = function(paper) {
    ...
    this.__element = paper.element;
    this.__ctx = paper.ctx;
  ...
  ctx.prototype.draw = function() {
    this.__element.parentNode.replaceChild(this.__root, this.__element);
  };
